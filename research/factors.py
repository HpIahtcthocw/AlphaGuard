...
FACTOR_REGISTRY: Dict[str, FactorSpec] = {
    "RET-1D": FactorSpec("RET-1D", "1-day return", "close / close[-1] - 1", ("close",), "1d", "higher-is-stronger", ("CN", "US", "HK")),
    "RET-20D": FactorSpec("RET-20D", "20-day return", "close / close[-20] - 1", ("close",), "20d", "higher-is-stronger", ("CN", "US", "HK")),
    "MOM-126D": FactorSpec("MOM-126D", "126-day momentum", "close / close[-126] - 1", ("close",), "126d", "higher-is-stronger", ("CN", "US", "HK")),
    "VOL-RATIO-5D": FactorSpec("VOL-RATIO-5D", "5-day volume ratio", "volume / mean(volume[-5:-1])", ("volume",), "5d", "higher-is-stronger", ("CN", "US", "HK")),
    "BREAKOUT-252D": FactorSpec("BREAKOUT-252D", "252-day new-high breakout", "close > max(close[-252:-1])", ("close",), "252d", "higher-is-stronger", ("CN", "US", "HK"), known_risks="Requires adjusted prices and sufficient history length"),
    "BREAKOUT-COUNT-20D": FactorSpec("BREAKOUT-COUNT-20D", "20-day valid new-high breakout count", "rolling sum of first-breakout events", ("close",), "20d", "higher-is-stronger", ("CN", "US", "HK"), known_risks="Does not re-count while the price keeps standing at highs"),
    "SURGE-COUNT-20D": FactorSpec("SURGE-COUNT-20D", "20-day large-up event count", "count(return >= 10%)", ("close",), "20d", "higher-is-stronger", ("CN", "US", "HK"), known_risks="Not a uniform cross-market price-limit-up rule"),
    "CRASH-COUNT-20D": FactorSpec("CRASH-COUNT-20D", "20-day large-down event count", "count(return <= -10%)", ("close",), "20d", "higher-is-stronger", ("CN", "US", "HK"), known_risks="Not a uniform cross-market price-limit-down rule"),
    "DRAWDOWN-20D": FactorSpec("DRAWDOWN-20D", "20-day drawdown", "close / rolling_max(close,20) - 1", ("close",), "20d", "lower-is-better", ("CN", "US", "HK")),
    "DRAWDOWN-120D": FactorSpec("DRAWDOWN-120D", "120-day drawdown", "close / rolling_max(close,120) - 1", ("close",), "120d", "lower-is-better", ("CN", "US", "HK")),
    "UP-DOWN-VOLUME-20D": FactorSpec("UP-DOWN-VOLUME-20D", "up/down volume ratio", "sum(volume on up days) / sum(volume on down days)", ("close", "volume"), "20d", "higher-is-stronger", ("CN", "US", "HK")),
    "MA-DIST-7D": FactorSpec("MA-DIST-7D", "distance to MA7", "close / MA7 - 1", ("close",), "7d", "higher-is-stronger", ("CN", "US", "HK")),
    "MA-DIST-30D": FactorSpec("MA-DIST-30D", "distance to MA30", "close / MA30 - 1", ("close",), "30d", "higher-is-stronger", ("CN", "US", "HK")),
    "MA-DIST-60D": FactorSpec("MA-DIST-60D", "distance to MA60", "close / MA60 - 1", ("close",), "60d", "higher-is-stronger", ("CN", "US", "HK")),
    "SUPPORT-BREAK-20D": FactorSpec("SUPPORT-BREAK-20D", "20-day support-break count", "count(close < prior rolling low)", ("close",), "20d", "lower-is-better", ("CN", "US", "HK")),
    "MARKET-RET-20D": FactorSpec("MARKET-RET-20D", "market 20-day return", "benchmark close / close[-20] - 1", ("benchmark_close",), "20d", "regime", ("CN", "US", "HK")),
    "MARKET-TREND": FactorSpec("MARKET-TREND", "market trend state", "benchmark close above/below MA60 and MA120", ("benchmark_close",), "60/120d", "regime", ("CN", "US", "HK")),
}
